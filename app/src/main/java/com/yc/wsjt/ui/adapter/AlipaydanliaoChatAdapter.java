...
public class AlipaydanliaoChatAdapter extends BaseQuickAdapter<WeixinChatInfo, BaseViewHolder> {

    private Context mContext;

    public AlipaydanliaoChatAdapter(Context context, List<WeixinChatInfo> datas, int tempWidth) {
        super(R.layout.alipay_danliao_chat_item, datas);
