...
import com.yc.wsjt.api.HomeDataInfoService;
...
public class HomeInfoModelImp extends BaseModel implements HomeInfoModel<HomeDateInfoRet> {

    private Context context;
    private HomeDataInfoService homeDataInfoService;
    private CompositeSubscription mCompositeSubscription;

    public HomeInfoModelImp(Context context) {
    ...
    @Override
    public void getHomeList(final IBaseRequestCallBack<HomeDateInfoRet> iBaseRequestCallBack) {
        RequestBody requestBody = RequestBody.create(MediaType.parse("application/json"), "");

        mCompositeSubscription.add(homeDataInfoService.getHomeList(requestBody)
